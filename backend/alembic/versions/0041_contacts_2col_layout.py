"""Contacts: 2-column layout — combined contacts card + plain Sunday card

Revision ID: 0041_contacts_2col_layout
Revises: 0040_contacts_info_cards
...
revision: str = "0041_contacts_2col_layout"
down_revision: Union[str, None] = "0040_contacts_info_cards"
