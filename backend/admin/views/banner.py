...
class BannerAdmin(AdminOnly, ModelView, model=Banner):
    ...
    form_args = {
        ...
        "placement": {
            ...
            "страницы. «Боковая панель» — баннеры в правом сайдбаре сайта. «Лента» — баннеры "
            "между объявлениями в ленте «Все объявления» на главной (размеры leaderboard 970×90 "
            "или wide 800×200). Количество задаётся числом записей; пустые баннеры показываются "
            "как заглушки «Рекламный баннер сдаётся».",
        },
        "size": {
