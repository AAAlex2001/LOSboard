    ...
    form_args = {
        ...
        "body": {
            "description": (
                ...
                "[PHONE WxH название], [NOTE текст], [HINT текст]. Карточки: "
                "[INFO Заголовок] … [/INFO] (синяя), [INFO! Заголовок] … [/INFO] (выделенная) "
                "и [INFO- Заголовок] … [/INFO] (без фона). Внутри INFO можно добавлять "
                "подзаголовки строкой [LABEL Текст]. Каждый маркер — отдельным абзацем."
            ),
        },
    }
